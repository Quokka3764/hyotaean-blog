...
date: '2025-04-15 17:27'
thumbnail: '/nextJs.avif'
tags: ["Next.js", "개발 블로그", "UI/UX"]
...
![HeroSection_white](/white-herosection.png)
*라이트모드

![HeroSection_dark](/dark-herosection.png)
*다크모드
...
단색 배경은 너무 단조로운 것 같아서 추가적인 취향을 더했다. 라이트모드와 다크모드 모두 적절해 보이는 그라데이션을 적용해서 최대한 심심해 보이지 않게 노력했다. 이렇게 성능과 시각적인 부분, 그리고 가독성 사이에서 균형을 찾다보니 생각보다 많은 시간이 걸리게 됐다.
